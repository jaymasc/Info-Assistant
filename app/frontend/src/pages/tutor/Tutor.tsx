...
return (
    ...
    <span className={styles.chatEmptyObjectives}>
      <i className={styles.centered}>Navigator.gpt uses AI. Check for mistakes.</i> <a href="https://github.com/microsoft/PubSec-Info-Assistant/blob/main/docs/transparency.md" target="_blank" rel="noopener noreferrer"> Transparency Note</a>
    </span>
