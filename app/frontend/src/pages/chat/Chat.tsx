            ...
            <div className={styles.chatRoot}>
                <div className={styles.chatContainer}>
                        ...
                        <div className={styles.chatEmptyState}>
                            {activeChatMode == ChatMode.WorkOnly ? 
                                <div>
                                    ...
                                    <h1 className={styles.chatEmptyStateTitle}>Chat with your Key USCG Resources</h1>
                                </div>
                            ...
                            <span className={styles.chatEmptyObjectives}>
                                <i>Navigator.gpt uses AI. Check for mistakes.   </i><a href="https://github.com/microsoft/PubSec-Info-Assistant/blob/main/docs/transparency.md" target="_blank" rel="noopener noreferrer">Transparency Note</a>
                            </span>
                    ...
                    <div className={styles.chatInput}>
                        ...
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. What are internal controls?)"
                            disabled={isLoading}
